...
public class MainActivity extends AppCompatActivity {
    ...
    private MappedByteBuffer loadmodelfile(Activity activity) throws IOException {
        AssetFileDescriptor fileDescriptor=activity.getAssets().openFd(/*"cartoon_model.tflite"*/"model_cnn.tflite");
...
//To set components of x axis
    ...
    private void showresult(){
        ...
        try{
            labels = FileUtil.loadLabels(MainActivity.this,/*"cartoon_labels.txt"*/"lab.txt");
        }catch (Exception e){
            System.out.println("subham "+e);
            e.printStackTrace();
        }
      /*  Map<String, Float> labeledProbability =
        ...
        if (result < 0.5) {
            ...
            System.out.println("subham 1");
            prediction.setText("COVID INFECTED");
             } else {
            // means prediction was for category corresponding to 1 }
            System.out.println("subham 2");
            prediction.setText("No Infection");
        }
